...
int main() {
    ...
    double max_sim_time = 100000000.0;  // 模拟将运行的最大总时间。当模拟时间达到这个值时，程序会停止。
    long long int max_sim_steps = 100000000;    
    ...
    KMC_Simulator simulator(num_sites, box_size, seed, jump_distance, CSVflag, GB_A, GB_B, GB_C, GB_D, Diff_mod);
